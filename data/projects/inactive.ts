...
/**
 * Archived/Inactive projects - No longer maintained
 * Useful for portfolio showcasing learnings and past work
 */
export const inactiveProjects: IProjects[] = [
    {
        id: 8,
        slug: "chat-codebhaiya",
        title: "Chat.Codebhaiya",
        description:
            "AI-powered chat application built with modern web technologies",
        longDescription: `Chat CodeBhaiya is an interactive chat application featuring AI capabilities. Built with a modern tech stack, it provides real-time messaging and intelligent responses.
...
- User authentication`,
        ...
        techstack: ["Node.js", "Express", "React", "TypeScript"],
        thumbnailUrl: "/chat-codebhaiya.png",
