    ...
    return (
        <section className="my-4 border-b border-b-gray-300 pb-2">
            ...
            <div className="flex text-3xl space-x-2 ml-1">
                <Link
                    className="w-10 hover:scale-110 transition-all duration-300 text-[#0077B5]"
                ...
                <Link
                    ...
                    href="https://x.com/AbhinayJangde"
                >
                    <FaSquareXTwitter />
                </Link>
                <Link
                    className="w-10 hover:scale-110 transition-all duration-300"
                    href="https://github.com/abhinayjangde"
                >
                    <FaGithub />
                </Link>
                <Link
                    className="w-10 hover:scale-110 transition-all duration-300 text-[#FF0000]"
